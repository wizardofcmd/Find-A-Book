$(document).ready(function() {
  ...
  document.getElementById("h_label").innerHTML = jsarray[0].slice();
  document.getElementById("h_desc").innerHTML = jsarray[1].slice();
  document.getElementById("h_author").innerHTML = jsarray[2].slice(2,-2);
  document.getElementById("h_genre").innerHTML = jsarray[3].slice(2,-2);
  document.getElementById("h_isbn").innerHTML = jsarray[6].slice(1,-1);
  document.getElementById("h_rating").innerHTML = jsarray[7].slice(1,-1);
