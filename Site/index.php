...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="page-section portfolio" id="books">
            <div class="container">
				...
				<!-- Sub Genre Buttons Container -->
				<div class="row justify-content-center" id="initialButtons">
				...
				<div class="row justify-content-center" id="finalButtons">
					<!-- Secondary Sub Genre Buttons Container -->
					<!-- SubGenre Item 7-->
					<div class="col-md-6 col-lg-4 mb-5">
						<h3 class="page-section-heading text-center text-uppercase text-secondary mb-0">Non-Fiction</h3>						
                        <div class="portfolio-item mx-auto"  data-toggle="modal" data-target="#portfolioModal1">
	...
	<!-- Reviews Section -->
	<section class="page-section bg-primary text-white mb-0" id="reviews">
		<div class="container">
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<!-- Portfolio Modal - ArborJS Canvas-->
								<div class="row">
									
									<div class="col-sm-5">
									</div>
									<canvas id="viewport"  class="row "width="800" height="400"></canvas>
									<div class="col-sm-5">
									</div>
								</div>
	...
	<div class="portfolio-modal modal fade" id="portfolioModal1" tabindex="-1" role="dialog" aria-labelledby="portfolioModal3Label" aria-hidden="true">
		<div class="modal-dialog modal-xl" role="document">
			<div class="modal-content">
				<button class="close" type="button" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true"><i class="fas fa-times"></i></span>
