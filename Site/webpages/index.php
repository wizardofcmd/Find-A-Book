...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="./assets/img/portfolio/circle-cropped.png" />
    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">The hardest part is picking the right one, not anymore !</p>
            </div>
        </header>
        <!-- Portfolio Section-->
...
<div class="collapse" id="collapseExample">
  ...
  <button type="submit" class="btn btn-primary">Enter your review!</button>
</form>
  </div>
</div>
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
...
<<<<<<< Updated upstream
=======
>>>>>>> 8730104f5028412a917436e829a7a8d58e35bcff
>>>>>>> Stashed changes
